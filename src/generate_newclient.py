...
new_clients_full = new_clients.merge(marketing, on="customerID")\
                              .merge(transactions, on="customerID")\
                              .merge(support, on="customerID")

# Sauvegarder le CSV final
new_clients_full.to_csv("data/raw/new_clients.csv", index=False)
print("Merged CSV saved to data/raw/new_clients.csv")
